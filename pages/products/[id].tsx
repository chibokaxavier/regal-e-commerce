...
const ProductDetails = () => {
  ...
  return (
    <>
      ...
      <div className="h-[1000px]  lg:pb-32 flex items-center justify-center px-10 font-serif">
        <div className="flex flex-col  lg:flex-row items-center justify-between lg:pt-[180px] pt-[100px]">
          <div className="flex flex-1 justify-center items-center mb-8 lg:mb-0 lg:h-[500px] h-[250px] ">
            <img
              src={image}
              alt=""
              className="max-w-[200px] h-full lg:max-w-sm"
            />
          </div>
          ...
          <div className="flex-col flex h-[500px] lg:block  justify-center items-center space-y-8 lg:text-left lg:ml-[200px] lg:pt-0">
            ...
            <div className="p-4 text-green-500 border-2 w-[250px] flex items-center justify-center text-sm cursor-pointer">
              ORDER VIA WHATSAPP
            </div>
            <div className="">
              <button
